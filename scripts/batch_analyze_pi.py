...
# CONFIG
# =========================
DATA_GLOB = "../data/pi_run_*.csv"      # ajusta si tus nombres difieren
OUT_FIG_DIR = "../figures"
OUT_DOC_DIR = "../docs"
...
def save_txt(run_id, csv_path, fig_path, res):
    ...
    lines = []
    lines.append(f"=== RESULTADOS PI ({run_id}) ===\n")
...
summary_txt = os.path.join(OUT_DOC_DIR, "pi_summary.txt")
with open(summary_txt, "w", encoding="utf-8") as f:
    f.write("=== RESUMEN GLOBAL PI (todos los ensayos) ===\n\n")
